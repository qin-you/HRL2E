...
def log_video_hrl(env_name, agents_l, en_utils, actor_high, gates, params):
    ...
    while not done and step < params.policy_params.episode_len:
        ...
        action = en_utils.en_pick_action(state, goal, agents_l, params.policy_params.max_action, change=True, steps=None, goal_dim=goal_dim, epsilon=0, ucb_lamda=0, gates=gates, option='gate', gate_pretrain_steps=math.inf)[0].detach().cpu()
