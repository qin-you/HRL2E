...
def train(params):
    ...
    for t in range(step, max_timestep):
        ...
        if t < start_timestep:
            ...
            a_tmp, mask = en_utils.en_pick_action(state, goal, en_agents, max_action, (t+1)%c==1, t, goal_dim, epsilon=0.5, ucb_lamda=10., gates=gates, option='gate',gate_pretrain_steps=t-start_timestep)     # episode_timestep_h==1      (t+1)%c==1
