...
def create_rl_components(params, device):
    ...
    experience_buffer_h = ExperienceBufferHigh(int(policy_params.max_timestep / policy_params.c ) + 1, state_dim, goal_dim, params.use_cuda, policy_params.c, action_dim)
