...
def train(params):
    ...
    for t in range(step, max_timestep):
        ...
        if t < start_timestep:
            ...
            a_tmp, mask = en_utils.en_pick_action(state, goal, en_agents, max_action, (t+1)%c==1, t, epsilon=0, ucb_lamda=10., gate=gate_net, option='gate')     # episode_timestep_h==1      (t+1)%c==1
